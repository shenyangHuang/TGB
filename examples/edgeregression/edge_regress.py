...
class PersistentForcaster:
    def __init__(self, train_data, val_data):
        ...
        self.update_memory_by_edges(train_data["sources"], train_data["destinations"], train_data["y"])
        # update the memory with the validation edges
        self.update_memory_by_edges(val_data["sources"], val_data["destinations"], val_data["y"])
    ...
    def compute_edge_weights(self, sources, destinations):
        """
